...
public class ENGRC {
	...
	public void ENGRCCreateAndDeleteRisk()
		...
		test = extent.startTest(Thread.currentThread().getStackTrace()[1].getMethodName(),
			...
			//driver.findElement(By.xpath("//div[@class='menu-list']//li[3]")).click();
...
//app-sidebar//div[@class='menu-list']/ul/li[2]
		 ...
		 wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//div//a//img[@alt='Add'])[1]")));
			...
			driver.findElement(By.xpath("//input[@formcontrolname='riskName']")).sendKeys("Sample Risk");
			...
			driver.findElement(By.xpath("//input[@aria-controls='riskListTable']")).sendKeys("Sample Risk");
