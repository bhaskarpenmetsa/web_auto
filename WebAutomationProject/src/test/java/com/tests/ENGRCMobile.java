...
public class ENGRCMobile {
	...
	public void ShoppingCart() throws MalformedURLException, InterruptedException {
		...
		caps.setCapability("username", "oauth-infotechdemoacc20-2482b");
		caps.setCapability("accesskey", "3b2402c0-fe2a-429b-a142-b533caed21f6");
		caps.setCapability("name", "SampleTest");
		caps.setCapability("build", "Build11");
		
		MutableCapabilities caps = new MutableCapabilities();
		caps.setCapability("deviceName", "iPhone 13 Pro Max Simulator");
		caps.setCapability("deviceOrientation", "portrait");
		caps.setCapability("platformVersion", "15.0");
		caps.setCapability("platformName", "iOS");
		caps.setCapability("browserName", "Safari");
		caps.setCapability("username", "oauth-infotechdemoacc21-ec740");
		caps.setCapability("accesskey", "2ea8e774-070a-4790-8243-40667799793c");
		caps.setCapability("name", "SampleTest");
		caps.setCapability("build", "Build11");
		*/
		MutableCapabilities caps = new MutableCapabilities();
