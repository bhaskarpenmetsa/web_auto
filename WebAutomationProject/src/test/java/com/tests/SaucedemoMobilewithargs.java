...
public class SaucedemoMobilewithargs {
    ...
    @BeforeMethod
	public void ShoppingCart(String deviceName,String osversion,String platformName,String browserName,String userName,String accesskey,String testName,String build) throws MalformedURLException, InterruptedException {
