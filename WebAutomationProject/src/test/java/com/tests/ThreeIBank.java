...
public class ThreeIBank {
	...
	public void ShoppingCart() throws MalformedURLException, InterruptedException {
		...
		System.out.println("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&*************************");
		driver.get("http://10.1.127.121:5601/3ibank/index.html");
	...
	public void ThreeIBankLoanSubmission() throws IOException, InterruptedException, AWTException {
		...
		Thread.sleep(500);
		wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//div[@class='submit_form']/div/h6[text()=' Details Submitted Successfully ']")));

		String fileName4 = "EmploymentDetails.png";
		takeScreenshotImage(fileName4);

		if (driver.findElement(By.xpath("//div[@class='submit_form']/div/h6[text()=' Details Submitted Successfully ']")).isDisplayed()) {
